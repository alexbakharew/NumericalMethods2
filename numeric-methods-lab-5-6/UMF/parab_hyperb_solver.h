...
class ParabHyperbSolver : public BasicSolver// It is not a pure abstract class
{
    friend class SolutionSaver;
public:
    ParabHyperbSolver(){}
    //virtual ~ParabHyperbSolver();
    explicit ParabHyperbSolver(int N, int K, double l, int T, double a, MethodName(method), double teta = 0);
